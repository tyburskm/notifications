...
namespace NotificationsWeb
{
    public class LogsController : Controller
    {
        ...
        public LogsController(notificationsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Source,Message,Type,CreatedDate")] Logs logs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Source,Message,Type,CreatedDate")] Logs logs)
        {
            if (id != logs.Id)
            {
                return NotFound();
